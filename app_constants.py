...
DELIVERIES_LOG_WORKSHEET_NAME = "deliveries_log"
CONSUMABLES_DELIVERIES_LOG_WORKSHEET_NAME = "consumable_deliveries_log"
...
CONSUMABLE_ACTIVITY_COLORS = ("#74a8d1", "#74a8d1")
